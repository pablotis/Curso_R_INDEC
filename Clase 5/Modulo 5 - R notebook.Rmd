...
subtitle: "Explicación del uso de R Markdown para generar informes"
...
Para producir un reporte completo que contenga todo el texto, código y resultados, podemos clickear en __Knit__ o presionar `Ctrl + Shift + K`. Esto mostrará el reporte en el panel _Viewer_ y creará un archivo HTML independiente que podremos compartir con otros.



Los bloques de código se pueden ejecutar haciendo click en el ícono __ejecutar__ (el botón de _Play_ en la parte superior/derecha del bloque), o presionando `Ctrl + Shift + Enter`. RStudio ejecuta el código y muestra los resultados incustrados en el código.
...
El texto en los archivos .Rmd está escrita en Markdown, un lenguaje de marcado ligero que permite dar formato a archivos de texto plano. Markdown está diseñado para ser fácil de leer y fácil de escribir, siendo también muy fácil de aprender. Del _Cheatsheet_:
